export default {
	...
	home: {
		...
		app_description: "إدارة المئات من الايموتات لقنواتك على تويتش أو يوتيوب بسهولة",
	...
	activity: {
		...
		emote_processed: "تم إنهاء عاملية ل {T}",
	...
	emote: {
		...
		no_longer_available: "هذا الايموت لم يعد متوفر",
		delete_prompt: {
			heading: "حذف {0}",
			heading_versions: "حذف الإصدار '{0}' لـ {1}",
			notice: "هل ترغب حقّا بحذف الايموت '{0}'{'؟'}",
			notice_versions: "هل ترغب حقّا بحذف الإصدار {0} لـ {1}{'؟'}",
			reason: "سبب الحذف",
		},
		unlisted: {
			heading: "تنبيه!",
			warning: "هذا الإيموت غير مدرج علناً.",
			warning_flagged: "هذا الإيموت غير مدرج للأسباب التالية: {FLAG_LIST}",
			notice: "يمكنك إضافتها على قناتك الخاصة, ولكن لايمكننا التحقق إذا كانت آمنه للظهور على البث المباشر.",
			notice_flagged: "يمكنك إضافتها على قناتك الخاصة, ولكن نعتقد ان الإيموت غير آمن للظهور على البث المباشر.",
			show_button: "عرض الايموت",
			flag_sexual_content: "محتوى جنسي او موحي جنسياً",
			flag_epilepsy: "ومض سريع / محفز للنوبات",
			flag_edgy: "فاحشة أو مشمئز",
			flag_twitch_banned: "غير مسموح به على تويتش",
		},
		list: {
	...
	user: {
		...
		editors: "المعدلين",
		roles: "الأدوار",
		connections: "القنوات و الحسابات",
		new_connections: "ربط الحسابات...",
...
`,
			...
			report_closed: {
				...
				content: `
شكراً على إعلامنا, تم التعامل مع بلاغك {'#'}{CASE_ID}.				`,
			},
		},
	},
	// 404 Messages
