export default {
	...
	emote: {
		...
		unlisted: {
			heading: "Huomio!",
			warning: "Tämä emote ei ole julkisella listalla.",
	...
	user: {
		...
		joined_at: "Liityttiin {0}",
		editors: "Muokkaajat",
		roles: "Roolit",
		connections: "Kanavat | Kanavat & Tilit",
		new_connections: "Linkitä tilejä...",
...
`,
			...
			report_closed: {
				...
				content: `
Kiitos, että ilmoitit meille, raporttisi {'#'}{CASE_ID} on käsitelty.`,
			},
		},
	},
	// 404 Messages
