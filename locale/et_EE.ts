export default {
	...
	common: {
		...
		retry: "Proovi uuesti",
		back: "Tagasi",
		download: "Allalaadimine | Allalaadimine",
	...
	emote: {
		...
		no_longer_available: "See emote pole enam saadaval",
		delete_prompt: {
			heading: "Kustuta {0}",
			heading_versions: "Kustuta '{0}' versioon emoteist {1}",
			notice: "Kas olete kindel, et soovite kustutada emotei {0}{'?'}",
			notice_versions: "Kas olete kindel, et soovite kustutada '{0}' versiooni emoteist {1}{'?'}",
			reason: "Kustutamise põhjus",
		},
		unlisted: {
			heading: "Ettevaatust!",
