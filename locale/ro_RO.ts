export default {
	...
	emote: {
		...
		no_longer_available: "Acest emoticon nu mai este disponibil",
		delete_prompt: {
			heading: "Șterge {0}",
			heading_versions: "Șterge versiunea '{0}' pentru {1}",
			notice: "Ești sigur ca vrei să stergi emoticonul {0}{'?'}",
			notice_versions: "Ești sigur ca vrei sa ștergi versiunea '{0}' pentru {1}{'?'}",
			reason: "Motivul ștergerii",
		},
		unlisted: {
			heading: "Atenție!",
