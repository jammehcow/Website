export default {
	...
	emote: {
		...
		comments: "Commenti",
		channels: "Canali",
		common_names: "Altri nomi di questa emote",
		usage_stats: "Statistiche Emote",
		no_longer_available: "Questa emote non è più disponibile",
		delete_prompt: {
			heading: "Elimina {0}",
			heading_versions: "Elimina la versione '{0}' di {1}",
			notice: "Sei sicuro di voler eliminare l'emote {0}{'?'}",
			notice_versions: "Sei sicuro di voler eliminare la versione '{0}' da {1}{'?'}",
			reason: "Motivo dell'eliminazione",
		},
		unlisted: {
			heading: "Attenzione!",
			...
			notice: "Può essere aggiunta al tuo canale, ma non possiamo verificare se è sicura da mostrare in live.",
			notice_flagged:
				"Può essere aggiunta al tuo canale, tuttavia riteniamo che non sia sicura da mostrare in live.",
