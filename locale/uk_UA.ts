export default {
	...
	common: {
		...
		retry: "Повторити",
		back: "Назад",
		download: "Завантажити | Завантаження",
		features: "Функції",
		comments: "Коментарі",
		search: "Пошук",
		update: "Оновити",
	...
	home: {
		...
		features: {
			emote_sets: {
				name: "Набори емоцій",
				detail: "Групуйте емоції в налаштовувальні набори, якими ви можете поділитися з іншими користувачами або швидко перегорнути на свій канал.",
			},
			many_emote_slots: {
				name: "Сотні слотів для емоцій",
				detail: "Почніть с {0} слотів, з максимально можливою кількістю в {1} без плати.",
			},
			channel_emote_names: {
				name: "Ви можете назвати емоції унікально для вашого каналу",
			...
			real_time: {
				...
				detail: "Зміна емоцій у вашому каналі відбувається миттєво для всіх глядачів. F5 не потрібен.",
			},
			emote_versions: {
				name: "Версії емоцій",
				detail: "Поміняйте між тематичними варіантами або оновите емоцію на покращену версію.",
			},
			next_gen: {
				name: "Формати зображення нового покоління, як WEBP та AVIF",
				detail: "Ми використовуємо новіші, більш оптимізовані формати зображень для зменшення використання пропускної здатності.",
			},
			source_available: {
		...
		socials: {
			...
			discord_online_count: "{0} зараз в мережі",
	...
	nav: {
		...
		wip_notice: {
			...
			text2: "Дізнайтеся що нове і дайте нам відгук! Зверніть увагу, що сайт буде швидкі мінятися, і може часто ламатися.",
		},
	},
	activity: {
	...
	emote: {
		...
		preview_failed: "Не вдалося завантажити перегляді",
		...
		comments: "Коментарі",
		channels: "Канали",
		common_names: "Інші назви цієї емоції",
		usage_stats: "Статистика емоцій",
		no_longer_available: "Ця емоція більше не доступна",
		delete_prompt: {
			heading: "Видалити {0}",
			heading_versions: "Видалити '{0}' версію {1}",
			notice: "Ви впевнені, що бажаєте видалити емоцію {0}{'?'}",
			notice_versions: "Ви впевнені, що бажаєте видалити '{0}' версію з {1}{'?'}",
			reason: "Причина видалення",
		},
		unlisted: {
			heading: "Обережно!",
			warning: "Ця емоція не є загальнодоступною.",
			warning_flagged: "Ця емоція була вилучена з каталогу тому що вона: {FLAG_LIST}",
			notice: "Ви можете додати цю емоцію до свого каналу, але ми не можемо перевірити якщо вона безпечна для показання на прямому ефіру.",
			notice_flagged:
				"Ви можете додати цю емоцію до свого каналу, але ми вважаємо що вона небезпечна для показання на прямому ефірі.",
			show_button: "Розкрити емоцію",
			flag_sexual_content: "Має сексуальну тему, або сексуальний контент",
			flag_epilepsy: "Має швидке моргання / може викликати епілепсію",
			flag_edgy: "Має провокаційні та/або образливі теми",
			flag_twitch_banned: "Заборонена для Twitch",
		},
		list: {
			searching: "Шукаємо",
			emote_count: "{0} емоцій",
			no_emotes_listed: "Емоції не знайдені",
			fetching_slowly: "Вибачте, схоже що це займає деякий час",
		},
		upload: {
			...
			accepted_formats: "Прийнятні формати",
			filetype: "Файл",
			animation: "Анімація",
	...
	emote_set: {
		...
		select: "Виберіть @:common.object.emote_set",
		explain: {
		...
		label_default: "За умовчанням",
		modal: {
			selected_channel_count: "немає вибраного каналу | {0} канал обрано | {0} каналів обрано",
			create_button: "Створити @:common.object.emote_set",
			rename_in_set: "Перейменувати в {0}",
			context_rename: "Змінити назву емоції",
			context_set_default: "Призначити як замовчування",
	...
	reporting: {
		...
		emote_reason: {
			...
			i_appear_there: "Мене зображено на цій емоції, та мені це не подобається",
...
Тепер вона буде доступна в Каталозі емоцій і почнеться з'являтися на @:common.appHost{'.'}
`,
			},
			emote_not_listed: {
...
`,
			...
			report_closed: {
				...
				content: `
Дякуємо за ваше повідомлення, ваша скарга {'#'}{CASE_ID} була оброблено.
				`,
			},
		},
	},
