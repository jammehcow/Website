export default {
	...
	emote: {
		...
		no_longer_available: "Deze emote is niet meer beschikbaar",
		delete_prompt: {
			heading: "Verwijder {0}",
			heading_versions: "Verwijder versie '{0}' van {1}",
			notice: "Weet je zeker dat je emote '{0}' wilt verwijderen",
			notice_versions: "Weet je zeker dat je de versie '{0}' van {1}{'?'} wilt verwijderen",
			reason: "Reden voor verwijdering",
		},
		unlisted: {
			heading: "Attentie!",
