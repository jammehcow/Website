export default {
	...
	activity: {
		...
		emote_renamed: "שינה את שם {T} מ- {O} ל- {N}",
		...
		emote_processed: "ביצע משימת עיבוד חדשה בשביל {T}",
		...
		user_editor_added: "הוסיף את {U} בתור עורך",
		user_editor_added_other: "הוסיף את {U1} כעורך של {U2}",
		user_editor_removed: "ביטל את הרשאות העריכה של {U}",
		user_editor_removed_other: "ביטל את הרשאות העריכה של {U1} ב- {U2}",
	...
	emote: {
		...
		no_longer_available: "האימוט הזה לא זמין יותר",
		delete_prompt: {
			heading: "מחק את {0}",
			heading_versions: "מחק את גרסה '{0}' של {1}",
			notice: "אתה בטוח שאתה רוצה למחוק את האימוט {0}{'?'}",
			notice_versions: "אתה בטוח שאתה רוצה למחוק את הגרסה '{0}' מ-{1}{'?'}",
			reason: "סיבת מחיקה",
		},
		unlisted: {
			heading: "שים לב!",
			warning: "האימוט הזה לא נמצא ברשימה הפומבית.",
			warning_flagged: "האימוט הזה הוסר מהרשימה בגלל הסיבות הבאות: {FLAG_LIST}",
			notice: "אפשרי להוסיף את האימוט לערוץ שלך, אבל אנחנו לא יכולים לוודא שהוא בטוח להצגה בשידור חי.",
			notice_flagged: "אפשרי להוסיף את האימוט לערוץ שלך, אבל אנחנו מאמינים שלא בטוח להראות אותו בשידור חי.",
			show_button: "הראה אימוט",
			flag_sexual_content: "תוכן מיני או תוכן בעל רמיזות מיניות",
			flag_epilepsy: "הבזקים מהירים \\ מעוררי התקפים",
			flag_edgy: "נועז או חסר טעם",
			flag_twitch_banned: "לא מורשה ב-Twitch",
		},
		list: {
			searching: "מחפש",
	...
	user: {
		...
		editors: "עורכים",
		roles: "קבוצת משתמשים",
		connections: "ערוצים | ערוצים וחשבונות",
		new_connections: "קישור חשבונות...",
...
`,
			...
			report_closed: {
				subject: "דיווח סגור",
				content: `
תודה לך שיידעת אותנו, הדיווח שלך {'#'}{CASE_ID} טופל.
				`,
			},
		},
	},
