export default {
	...
	common: {
		...
		retry: "ხელახლა ცდა",
		back: "უკან",
		download: "ჩამოტვირთვა | ჩამოტვირთვები",
		features: "თვისებები",
	...
	activity: {
		...
		emote_processed: "შესრულებულია ახალი დავალება {T}-ისთვის",
	...
	emote: {
		...
		unlisted: {
			heading: "ყურადღება!",
			warning: "ეს ემოუთი არ არის საჯარო სიაში.",
			warning_flagged: "ეს ემოუთი იყო წაშლილი შემდეგი მიზეზების გამო: {FLAG_LIST}",
			notice: "თქვენ შეგიძლიათ მისი დამატება, მაგრამ, შეიძლება უსაფრთხო არ იყოს მისი ჩვენება ეთერში.",
			notice_flagged: "თქვენ შეგიძლიათ მისი დამატება, თუმცა ჩვენი აზრით, მისი ჩვენება ეთერში სახიფათოა.",
			show_button: "ემოუთის ჩვენება",
			flag_sexual_content: "სექსუალური ან სექსუალურად დამაფიქრებელი კონტენტი",
			flag_epilepsy: "სწრაფი ციმციმი / შეტევის გამომწვევი",
			flag_edgy: "მღელვარე ან უსიამოვნო",
			flag_twitch_banned: "აკრძალულია ტვიტჩზე",
		},
		list: {
			searching: "ძიება",
	...
	user: {
		...
		editors: "რედაქტორები",
		roles: "როლები",
		connections: "არხები | არხები და ექაუნთები",
		new_connections: "ექაუნთების მიბმა...",
...
`,
			...
			report_closed: {
				subject: "რეპორტი დახურულია",
				content: `
გმადლობთ, რომ შეგვატყობინეთ, თქვენი რეპორტი {'#'}{CASE_ID} დამუშავდა.`,
			},
		},
	},
	// 404 Messages
